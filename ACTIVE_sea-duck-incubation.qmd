...
```{r}
##### TO DO: WHERE ARE 2017/2018 NESTS HERE AND DOWNSTREAM?
...
```{r}
##### TO DO: WHERE IS "UNKNOWN" PREDATOR.
##### TO DO: INCLUDE DETAILS ON FOX CONTROL IN CAPTION.
...
```{r}
##### TO DO: CHANGE FOR AVG RECESS LENGTH
##### TO DO: ADDITIONAL TIME OF DAY RECESS FIGURE. 
##### TO DO: ADDITIONAL TIME OF DAY RECESS WITH HOURLY TEMP FIGURE. 
...
```{r}
##### TO DO: FIND AND FIX LENGTHY SPEI RECESSES. 
...
```{r}
##### TO DO: CHECK LTDU AND OTHERS FOR FAILURES DURING LAYING. IF YES, INCLUDE WRITTEN DESCRIPTION 
...
```{r}
##### TO DO: MAKE NORMAL TEXT BC LTDU IS CUT OFF. 
...
```{r}
##### TO DO: FIND MISSING ERROR BARS. 
##### TO DO: MAKE SIMILAR FIGURES FOR DURATION OF RECESS AND NUMBER OF RECESSES. 
##### TO DO: EXPERIMENT WITH SIMPLE REGRESSIONS ON THIS. 
...
```{r}
##### TO DO: PROVIDE MORE DETAILS ON THIS PROCESS
##### TO DO: PROVIDE A COUNT OF NESTS WITH ALL VARIABLES IN GLMM.
...
##### TO DO: DISPLAY THIS PLOT WITHOUT DAY OF YEAR TRANSFORMATION.
...
-   Weather variables had no detectable effect
    ...
    -   **Interpretation:** Daily weather did not significantly influence time spent

TO DO:

-   ADD FIGURE FOR TIME OF DAY BREAKS OCCUR. INCORPORTATE HOURLY WX.
